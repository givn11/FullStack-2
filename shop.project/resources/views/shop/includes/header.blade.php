                    ...
                    <div class="shopping_cart">
                        <div class="cart_box">
                            <div class="message">
                                ...
                                <div class="list_img"><img src="{{asset('shop')}}images/si.jpg" class="img-responsive" alt=""></div>
                        ...
                        <div class="cart_box">
                            <div class="message1">
                                ...
                                <div class="list_img"><img src="{{asset('shop')}}images/si1.jpg" class="img-responsive" alt=""></div>
                                <div class="list_desc"><h4><a href="#">velit esse molestie</a></h4>
