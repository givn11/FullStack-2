<div class="col-md-3 col-md">
    <div class=" possible-about">
        ...
        <div class="tab1">
            <ul class="place">
                ...
                <li class="by"><img src="{{asset('shop')}}/images/do.png" alt=""></li>
    ...
    <div class="content-bottom-grid">
        ...
        <div class="latest-grid">
            <div class="news">
                <a href="single.html"><img class="img-responsive" src="{{asset('shop')}}/images/si.jpg" title="name" alt=""></a>
            </div>
            <div class="news-in">
        ...
        <div class="latest-grid">
            <div class="news">
                <a href="single.html"><img class="img-responsive" src="{{asset('shop')}}/images/si1.jpg" title="name" alt=""></a>
            </div>
            <div class="news-in">
                <h6><a href="single.html">Product name here</a></h6>
                <p>Description Lorem ipsum </p>
    ...
    <div class="money">
        ...
        <ul class="money-in">
            <li><a href="single.html"><img class="img-responsive" src="{{asset('shop')}}/images/p1.png" title="name" alt=""></a></li>
            <li><a href="single.html"><img class="img-responsive" src="{{asset('shop')}}/images/p2.png" title="name" alt=""></a></li>
            <li><a href="single.html"><img class="img-responsive" src="{{asset('shop')}}/images/p3.png" title="name" alt=""></a></li>
            <li><a href="single.html"><img class="img-responsive" src="{{asset('shop')}}/images/p4.png" title="name" alt=""></a></li>
            <li><a href="single.html"><img class="img-responsive" src="{{asset('shop')}}/images/p5.png" title="name" alt=""></a></li>
            <li><a href="single.html"><img class="img-responsive" src="{{asset('shop')}}/images/p6.png" title="name" alt=""></a></li>
            <li><a href="single.html"><img class="img-responsive" src="{{asset('shop')}}/images/p1.png" title="name" alt=""></a></li>
            <li><a href="single.html"><img class="img-responsive" src="{{asset('shop')}}/images/p4.png" title="name" alt=""></a></li>
            <li><a href="single.html"><img class="img-responsive" src="{{asset('shop')}}/images/p2.png" title="name" alt=""></a></li>
